...
function createSimplePNG() {
    ...
    const pngData = Buffer.from([
        ...
        0x08, 0x02, 0x00, 0x00, 0x00, 0x90, 0x77, 0x53,  // 位深度、颜色类型等
        0xDE, 0x00, 0x00, 0x00, 0x0C, 0x49, 0x44, 0x41,  // IDAT块
        0x54, 0x08, 0x99, 0x01, 0x01, 0x00, 0x00, 0xFF,  // 图像数据
        0xFF, 0x00, 0x00, 0x00, 0x02, 0x00, 0x01, 0xE2,  // CRC
        0x21, 0xBC, 0x33, 0x00, 0x00, 0x00, 0x00, 0x49,  // IEND块
        0x45, 0x4E, 0x44, 0xAE, 0x42, 0x60, 0x82          // 结束
    ]);
...
function createColoredPNG(size) {
    ...
    // 计算IDAT CRC
    const idatCrc = require('crypto').createHash('crc32').update(idatData.slice(4, 8 + compressedData.length)).digest();
