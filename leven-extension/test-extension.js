...
class ExtensionTester {
  constructor() {
    ...
    this.requiredFiles = ["manifest.json", "popup.html", "popup.js"];
    this.requiredIcons = ["icon16.png", "icon48.png", "icon128.png"];
    this.testResults = [];
  }
  ...
  async runAllTests() {
    ...
    const tests = [this.testDirectoryStructure(), this.testManifestJson(), this.testPopupFiles(), this.testIcons()];
