    ...
    <div className="flex justify-between items-center mb-6">
      <div className="flex items-center space-x-4">
        <div className="flex items-center space-x-2">
          <Switch checked={isDeveloperMode} onCheckedChange={onDeveloperModeChange} id="developer-mode" />
          <label
      ...
      {isDeveloperMode && (
        <div className="flex space-x-2">
          <Button variant="outline" size="sm" onClick={handleLoadUnpacked} disabled={isLoading} className="gap-2">
            <FolderOpen size={16} />
            {isLoading ? "加载中..." : "加载扩展"}
          </Button>
          <Button variant="outline" size="sm" onClick={handlePackExtension} className="gap-2">
            <Package size={16} />
            打包扩展
          </Button>
          <Button variant="outline" size="sm" onClick={handleUpdateExtension} className="gap-2">
            <RefreshCw size={16} />
            更新
          </Button>
        </div>
