...
class ExtensionDownloadTest {
  ...
  async run() {
    ...
    try {
      ...
      if (results.flowBrowser.startup.success) {
        results.flowBrowser.extensionDownload = await this.flowBrowserTester.simulateExtensionDownload(CONFIG.TEST_EXTENSION_ID);
  ...
  generateSummary(results) {
    ...
    const systemSuccess = results.system.diskSpace.success && results.system.filePermissions.success && results.system.tempDirectory.success;
